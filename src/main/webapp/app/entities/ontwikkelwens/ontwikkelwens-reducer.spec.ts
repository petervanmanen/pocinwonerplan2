...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ONTWIKKELWENS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ONTWIKKELWENS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ONTWIKKELWENS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ONTWIKKELWENS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ONTWIKKELWENS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ONTWIKKELWENS actions', async () => {
      const arg = 42666;
