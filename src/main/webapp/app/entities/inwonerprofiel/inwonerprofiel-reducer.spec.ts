...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INWONERPROFIEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INWONERPROFIEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INWONERPROFIEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INWONERPROFIEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INWONERPROFIEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INWONERPROFIEL actions', async () => {
      const arg = 42666;
