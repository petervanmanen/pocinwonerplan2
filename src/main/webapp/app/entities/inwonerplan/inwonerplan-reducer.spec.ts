...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INWONERPLAN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INWONERPLAN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INWONERPLAN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INWONERPLAN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INWONERPLAN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INWONERPLAN actions', async () => {
      const arg = 42666;
