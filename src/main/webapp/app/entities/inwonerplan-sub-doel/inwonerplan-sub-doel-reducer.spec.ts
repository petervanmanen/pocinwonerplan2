...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './inwonerplan-sub-doel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INWONERPLANSUBDOEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INWONERPLANSUBDOEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INWONERPLANSUBDOEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INWONERPLANSUBDOEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INWONERPLANSUBDOEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INWONERPLANSUBDOEL actions', async () => {
      const arg = 42666;
