...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './subdoel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBDOEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUBDOEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUBDOEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SUBDOEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SUBDOEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUBDOEL actions', async () => {
      const arg = 42666;
