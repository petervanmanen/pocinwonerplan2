...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './inwonerplan-activiteit.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INWONERPLANACTIVITEIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INWONERPLANACTIVITEIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INWONERPLANACTIVITEIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INWONERPLANACTIVITEIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INWONERPLANACTIVITEIT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INWONERPLANACTIVITEIT actions', async () => {
      const arg = 42666;
