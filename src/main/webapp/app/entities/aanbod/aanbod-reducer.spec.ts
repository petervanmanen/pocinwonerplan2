...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './aanbod.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AANBOD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AANBOD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AANBOD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AANBOD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AANBOD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AANBOD actions', async () => {
      const arg = 42666;
