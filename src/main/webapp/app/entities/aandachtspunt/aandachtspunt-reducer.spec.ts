...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AANDACHTSPUNT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AANDACHTSPUNT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AANDACHTSPUNT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AANDACHTSPUNT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AANDACHTSPUNT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AANDACHTSPUNT actions', async () => {
      const arg = 42666;
